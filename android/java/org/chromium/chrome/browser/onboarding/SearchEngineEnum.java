...
public enum SearchEngineEnum {
    ...
    DAUM(R.drawable.ecosia, SearchEngineEnumConstants.SEARCH_DAUM_ID, R.string.daum_desc),
    NAVER(R.drawable.ecosia, SearchEngineEnumConstants.SEARCH_NAVER_ID, R.string.naver_desc);
